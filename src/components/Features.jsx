                    ...
                    <div className="flex-center flex-col sm:px-10">
                        <div className="relative h-[50vh] w-full flex item-center">
                            <video className="w-full h-full object-cover object-center"
                                preload="none" muted playsInline id='exploreVideo' autoPlay ref={videoRef}>
                           ...
                           <div className="feature-text-container">
                            <div className="flex-1 flex-center">
                                    <p className="feature-text g_text">
                                       ...
                                       </span>, using the same alloy that spacecrafts use for mission to Mars.
                                    </p>
                                </div>
                                <div className="flex-1 flex-center">
                                    <p className="feature-text g_text">
                                       Titanium has one of the best strength-to-weight 
                                       ratios of any metal, making this our {''}
                                       <span className="text-white">
                                       lightest Pro models ever.
                                       </span>, You'll notice the diffrence the moment you pick it up!!
                                    </p>
                                </div>
                            </div>
                        </div>
